...
export function PathAnimation() {
    return (
        <Flex
            ...
            w="25rem"
        >
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" fill="url(#MyGradient)" x="0px" y="0px" viewBox="0 0 180 180">

                <defs>
                    <linearGradient id="MyGradient">
                        <stop offset="5%" stop-color="#ea8565" />
                        <stop offset="95%" stop-color="#f65d7c" />
                    </linearGradient>
                </defs>
                <path d="">
